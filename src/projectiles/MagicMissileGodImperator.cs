...
{
    public class MagicMissileGodImperator : MagicMissile
    {

        public bool doDraw = true;
        public MagicMissileGodImperator(Vector2 position, Orientation orientation, float movementSpeed = 10)
        {
            ...
            sprite.LoadAnimationsFromFile("Content/rsrc/spritesheets/configFiles/magic_missile_white.anm.txt", true);
            setAnimation();
            ...
            combatArgs.damage = 300 + GameplayState.PlayerTwo.expBar.Level * 2;
        ...
        private void spawnSplitMissiles()
        {
            List<MagicMissileSplit> missiles = new List<MagicMissileSplit>();
            //UP
            missiles.Add(
                new MagicMissileSplit(collisionBox.Location.ToVector2() +
            ...
            missiles.Add(
                ...
                new Vector2(-(collisionBox.Width + 1), -(collisionBox.Height + 1)),
                Orientation.UP_LEFT));
            foreach (MagicMissileSplit m in missiles)
            {
