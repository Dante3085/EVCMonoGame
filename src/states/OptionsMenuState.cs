...
{
    /// <summary>
    /// The options state is brought up over the top of the main menu
    /// state, and gives the user a chance to configure the game
    /// in various hopefully useful ways.
    /// </summary>
    internal class OptionsMenuState : MenuState
    {
        #region Fields
        ...
        /// <summary>
        /// Fills in the latest values for the options state menu text.
        /// </summary>
