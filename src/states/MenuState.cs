...
{
    /// <summary>
    /// Base class for states that contain a menu of options. The user can
    /// move up and down to select an entry, or cancel to back out of the state.
    /// </summary>
    internal abstract class MenuState : GameState
    {
        ...
        /// Constructor.
        /// </summary>
        public MenuState(string menuTitle)
        {
        ...
        /// <summary>
        /// Allows the state the chance to position the menu entries. By default
        /// all menu entries are lined up in a vertical list, centered on the state.
        /// </summary>
        protected virtual void UpdateMenuEntryLocations()
        {
            ...
            for (int i = 0; i < menuEntries.Count; i++)
            {
                ...
                position.X = StateManager.GraphicsDevice.Viewport.Width / 2 - menuEntry.GetWidth(this) / 2;

                if (StateBehaviour == StateBehaviour.TransitionOn)
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            GraphicsDevice graphics = StateManager.GraphicsDevice;
            ...
            // Draw the menu title centered on the state
