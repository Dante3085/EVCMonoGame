...
namespace EVCMonoGame.src
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            animatedSprite = new AnimatedSprite("rsrc/spritesheets/CronoTransparentBackground", 
                new Vector2(100, 100), 8.0f);

            // Frames sind leicht falsch(Abgeschnittene Ecken).
            animatedSprite.AddAnimation("IDLE", new Rectangle[]
            {
                new Rectangle(59, 14, 15, 34), new Rectangle(79, 14, 15, 34), new Rectangle(99, 14, 15, 34)
            }, 0.8f);
            animatedSprite.AddAnimation("WALK_UP", new Rectangle[]
            {
            ...
            animatedSprite.AddAnimation("WALK_LEFT", new Rectangle[]
            {
            ...
            animatedSprite.AddAnimation("WALK_DOWN", new Rectangle[]
            {
            ...
            animatedSprite.AddAnimation("WALK_RIGHT", new Rectangle[]
            {
            ...
            updateables.Add(animatedSprite);

            drawables = new List<IDrawable>();
            drawables.Add(fpsCounter);
            drawables.Add(animatedSprite);
