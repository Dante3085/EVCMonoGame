    ...
    public class PlayerTwo : Character, scenes.IDrawable
    {
        ...
        public void UpdateAttacks()
        {
                ...
                || InputManager.OnKeyPressed(Keys.A))
            {
                ...
                switch (playerOrientation)
                {
                    case Orientation.LEFT: nextAttackAnimation = "ATTACK_LEFT"; break;
                    ...
                    case Orientation.RIGHT: nextAttackAnimation = "ATTACK_RIGHT"; break;
            ...
            else if (InputManager.OnButtonPressed(Buttons.Y, PlayerIndex.Two))
            {
                ...
                switch (playerOrientation)
                {
                    case Orientation.LEFT: nextAttackAnimation = "THRUST_LEFT"; break;
                    case Orientation.UP_LEFT: nextAttackAnimation = "ATTACK_UP_LEFT"; break;
                    case Orientation.UP: nextAttackAnimation = "ATTACK_UP"; break;
                    case Orientation.UP_RIGHT: nextAttackAnimation = "ATTACK_UP_RIGHT"; break;
                    case Orientation.RIGHT: nextAttackAnimation = "THRUST_RIGHT"; break;
                    case Orientation.DOWN_RIGHT: nextAttackAnimation = "ATTACK_DOWN_RIGHT"; break;
                    case Orientation.DOWN: nextAttackAnimation = "ATTACK_DOWN"; break;
                    case Orientation.DOWN_LEFT: nextAttackAnimation = "ATTACK_DOWN_LEFT"; break;
                }
            ...
            else if (InputManager.OnButtonPressed(Buttons.B, PlayerIndex.Two))
            {
                ...
                switch (playerOrientation)
                {
                    case Orientation.LEFT: nextAttackAnimation = "ROUND_SWING_LEFT"; break;
                    case Orientation.UP_LEFT: nextAttackAnimation = "ATTACK_UP_LEFT"; break;
                    case Orientation.UP: nextAttackAnimation = "ATTACK_UP"; break;
                    case Orientation.UP_RIGHT: nextAttackAnimation = "ATTACK_UP_RIGHT"; break;
                    case Orientation.RIGHT: nextAttackAnimation = "ROUND_SWING_RIGHT"; break;
                    case Orientation.DOWN_RIGHT: nextAttackAnimation = "ATTACK_DOWN_RIGHT"; break;
                    case Orientation.DOWN: nextAttackAnimation = "ATTACK_DOWN"; break;
                    case Orientation.DOWN_LEFT: nextAttackAnimation = "ATTACK_DOWN_LEFT"; break;
                }
        ...
        public void UpdateMovement()
        {
            ...
            else
            {
                ...
                movementVector = directionVector * 
                                 (movementSpeed * (1 + InputManager.CurrentTriggers(PlayerIndex.Two).Right));
            }
